...
parser.add_argument('--num_point', type=int, default=4096, help='')
...
output_dir = os.path.join(data_dir, f'margonda_hdf5_data_{NUM_POINT}_uncol_try9')
